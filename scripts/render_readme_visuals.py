...
def render_c(photo: Image.Image, output: Path) -> None:
    ...
    draw.line((1170, 360, 1280, 360), fill=INK, width=7)
    draw.line((1210, 450, 1280, 450), fill=INK, width=7)
    draw.line((1170, 540, 1280, 540), fill=INK, width=7)
    draw.polygon(((1280, 360), (1262, 348), (1262, 372)), fill=INK)
    draw.polygon(((1280, 450), (1262, 438), (1262, 462)), fill=INK)
    draw.polygon(((1280, 540), (1262, 528), (1262, 552)), fill=INK)
    pill(draw, (1280, 333), "PACK", GREEN)
    pill(draw, (1280, 423), "REPAIR", ORANGE, WHITE)
    pill(draw, (1280, 513), "INSURE", BLUE, WHITE)
    image.save(output, optimize=True)
